...
namespace PseudoShadow
{
    public partial class frmGaussianBlur : Form
    {
        ...
        public frmGaussianBlur(Bitmap bmp)
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object? sender, DoWorkEventArgs e)
        {
            if (e.Argument != null && this._bmp != null)
            {
                ...
                _conv.CancelLoops = false;

                if (this.backgroundWorker1.CancellationPending)
                    _conv.CancelLoops = true;

                b = Fipbmp.FastZGaussian_Blur_NxN(bmp, blur, blur > 3 ? 0.01 : 0.16, 255, true, true,
                    true, true, true, true, _conv, true, false);

                bool bb = _conv.CancelLoops;
                e.Result = new object[] { bmp, blur, bb };
            }
        }

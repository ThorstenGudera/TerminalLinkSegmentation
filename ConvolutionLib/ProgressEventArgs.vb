...
Public Class ProgressEventArgs
    ...
    Public Sub New(ImageWidthHeight As Integer, StartValue As Integer, bgw As System.ComponentModel.BackgroundWorker)
        ImgWidthHeight = ImageWidthHeight
        CurrentProgress = StartValue
        Me.BGW = bgw
    End Sub

    Public Sub New(ImageWidthHeight As Integer, StartValue As Integer, Interval As Integer, bgw As System.ComponentModel.BackgroundWorker)
        ImgWidthHeight = ImageWidthHeight
        CurrentProgress = StartValue
        Me.BGW = bgw
    End Sub

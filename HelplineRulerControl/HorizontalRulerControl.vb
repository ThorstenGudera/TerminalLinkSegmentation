...
Partial Public Class HorizontalRulerControl
    Inherits Panel
    ...
    Public Sub New()
        ...
        Me.TickHeightSmall = Math.Max(Me.ClientSize.Height \ 5, 1)
        Me.TickHeightLarge = Math.Max(Me.ClientSize.Height \ 4, 1)

        Me.TickRelationSmall = CDbl(Me.TickHeightSmall) / Me.ClientSize.Height
        Me.TickRelationLarge = CDbl(Me.TickHeightLarge) / Me.ClientSize.Height
        ...
        If Me.ClientSize.Width > 0 AndAlso Me.ClientSize.Height > 0 Then
            ...
            Try
                ...
                Using g As Graphics = Graphics.FromImage(bmp)
                    g.Transform = New Matrix(1, 0, 0, -1, 0, Me.ClientSize.Height)
                    ...
                    While i < Me.DrawEnd
                        g.DrawLine(forePenSmall, New PointF(i, 0), New PointF(i, Me.TickHeightSmall))
                        i += Me.TickFrequencySmall * Zoom
                    End While

                    i = Me.DrawStart Mod (Me.TickFrequencyLarge * Zoom)
                    While i < Me.DrawEnd
                        g.DrawLine(forePenLarge, New PointF(i, 0), New PointF(i, Me.TickHeightLarge))
                    ...
                    If Me.ShowText Then
                        ...
                        While i < Me.DrawEnd
                            ...
                            g.DrawString(((-Me.DrawStart + i) / Zoom * ScaleFactor).ToString("N0"), Me.Font, textBrush, New PointF(i - (textSize.Width / 2.0F), Me.ClientSize.Height - Me.TickHeightLarge - textSize.Height))
    ...
    Protected Overrides Sub OnSizeChanged(e As EventArgs)
        ...
        If Me.RecalcHeightsOnResize Then
            Me.TickHeightSmall = CSng(Me.ClientSize.Height * Me.TickRelationSmall)
            Me.TickHeightLarge = CSng(Me.ClientSize.Height * Me.TickRelationLarge)
        End If
    End Sub

...
namespace AvoidAGrabCutEasy
{
    public partial class frmProcOutline : Form
    {
        ...
        {
            if (this.backgroundWorker11.IsBusy)
            {
        ...
        private void backgroundWorker11_DoWork(object? sender, DoWorkEventArgs e)
        {
            ...
            if (e.Argument != null)
            {
                ...
                this.backgroundWorker11.ReportProgress(50);
                ...
                this.backgroundWorker11.ReportProgress(100);
        ...
        private void backgroundWorker11_ProgressChanged(object? sender, ProgressChangedEventArgs e)
        {
            if (this.toolStripProgressBar1 != null && !this.toolStripProgressBar1.IsDisposed && this.toolStripProgressBar1.Visible)
                this.toolStripProgressBar1.Value = e.ProgressPercentage;
            else if (this.backgroundWorker11 != null && this.backgroundWorker11.IsBusy)
                this.backgroundWorker11.CancelAsync();
        }
        ...
        private void backgroundWorker11_RunWorkerCompleted(object? sender, RunWorkerCompletedEventArgs e)
        {
            if (!this.IsDisposed)
            {
                ...
                this.backgroundWorker11.Dispose();
                this.backgroundWorker11 = new BackgroundWorker();
                this.backgroundWorker11.WorkerReportsProgress = true;
                this.backgroundWorker11.WorkerSupportsCancellation = true;
                this.backgroundWorker11.DoWork += backgroundWorker11_DoWork;
                this.backgroundWorker11.ProgressChanged += backgroundWorker11_ProgressChanged;
                this.backgroundWorker11.RunWorkerCompleted += backgroundWorker11_RunWorkerCompleted;
            }
        }
    }
}

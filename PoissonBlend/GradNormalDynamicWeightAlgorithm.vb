...
Public Class GradNormalDynamicWeightAlgorithm
    ...
    Public Function GetValue(x As Integer, y As Integer, plane As Integer, col As Integer, colL As Integer, p() As Byte,
        ...
        If relDist > 1.0 Then
            value = (col - CDbl(p(x * 4 + y * scanline + plane))) * Me.UpperImgWeight
        Else
    ...
    Public Sub Setup(bmp As Bitmap, maxPixelDist As Integer, gamma As Double) Implements IExtendedBVectorComputingAlgorithm.Setup
        ...
        'Console.WriteLine(Me.DistanceArray.Length.ToString() & ";" & Me.MaxPixelDist.ToString() & ";" & Me.MaxDistInArray.ToString())
    End Sub
